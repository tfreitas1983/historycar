...
const ParceiroLogin = ({ navigation }) => (
    <View>            
        ...
        <LinearGradient  colors={['#ffad26', '#ff9900', '#ff5011']} style={styles.linearGradient}>     
            ...
            <Text style={styles.entrar} onPress={() => navigation.navigate('TemplateParceiro')}> <Entypo name="level-down" size={30} color="#d2d2d2" /> Entrar </Text>
