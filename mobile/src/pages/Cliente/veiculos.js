    ...
    <View>
        ...
        <ScrollView>
            ...
            <View style={styles.toogle}>
                <Text style={styles.titulo}  onPress={() => navigation.navigate('Detalhes')}>Jeep Compass KVV9U30</Text>
            ...
            <View style={styles.inativo}>
                <Text style={styles.titulo}  onPress={() => navigation.navigate('Detalhes')}>Hyundai Tucson KDY5374</Text>
                <Text style={styles.titulo} onPress={() => navigation.navigate('Detalhes')} > <Entypo name="text-document" size={30} /> </Text>
            </View>
