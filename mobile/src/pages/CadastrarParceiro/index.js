...
import { Text, View, StyleSheet, Dimensions, SafeAreaView, ScrollView, StatusBar} from 'react-native';
...
const CadastrarParceiro = ({ navigation }) => (
    <View>            
        ...
        <LinearGradient  colors={['#ffad26', '#ff9900', '#ff5011']} style={styles.linearGradient}>     
            <SafeAreaView >
                <ScrollView >
                    ...
                    <Text style={styles.opcoes}>  Nome ou Razão Social </Text>
